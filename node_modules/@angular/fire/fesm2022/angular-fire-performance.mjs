...
import { traceUntil as traceUntil$1, traceUntilComplete as traceUntilComplete$1, traceUntilFirst as traceUntilFirst$1, traceWhile as traceWhile$1 } from 'rxfire/performance';
...
const trace = _zoneWrap(trace$1, true, 2);
